          ...
          Get_armor_data(status.Get_armor()) * UPGRADE_MULTIPLIER}
{
    ...
    _icon_sprite.push_back(bn::sprite_items::icon_sword_upgrade.create_sprite(CURSOR_X+CURSOR_X_INT*2, 0));
    _icon_sprite.push_back(bn::sprite_items::icon_armor_upgrade.create_sprite(CURSOR_X+CURSOR_X_INT*3, 0));

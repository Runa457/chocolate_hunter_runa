...
constexpr Enemy_data Enemy_base_data[] = {
    ...
    Enemy_data(bn::sprite_items::enemy_abc_a, "Choco Attacker", 6, 9,      10, 13, 3, 6, Pattern_index::Slash), // Attacker
    Enemy_data(bn::sprite_items::enemy_abc_b, "Choco Blocker",  4, 7,      10, 5, 11, 6, Pattern_index::Guard), // Blocker
    Enemy_data(bn::sprite_items::enemy_abc_c, "Choco Charger",  6, 9,      10, 13, 7, 6, Pattern_index::Charge_Bash), // Charger
    Enemy_data(bn::sprite_items::enemy_abc_h, "Choco Healer",   5, 8,      10, 12, 7, 6, Pattern_index::AreaHeal), // Healer
    Enemy_data(bn::sprite_items::enemy_abc_n, "Choco Normal",   5, 7,      10, 9, 7, 6, Pattern_index::Bash), // Normal
